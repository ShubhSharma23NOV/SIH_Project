    ...
    return (
        <div className="water-quality-category">
            <div className="category-header">
                <h1>A2 - Outdoor Bathing (Organized)</h1>
                <p className="category-description">
                    Water quality monitoring for organized outdoor bathing areas
                </p>
            </div>
