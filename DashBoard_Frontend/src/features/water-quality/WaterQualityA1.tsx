    ...
    return (
        <div className="water-quality-category">
            <div className="category-header">
                <h1>A1 - Drinking Water Source (Without Treatment)</h1>
                <p className="category-description">
                    Water quality monitoring for sources intended for drinking without conventional treatment
                </p>
            </div>
